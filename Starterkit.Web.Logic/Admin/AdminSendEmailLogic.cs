...
{
    public class AdminSendEmailLogic : Starterkit.Web.Logic.Base.ILogic
    {
        public string SendEmail(string emailTo, string subject, string body)
        {
            ...
            try
            {
                ...
                AdminEmailDA emailDA = (AdminEmailDA)DataAccessFactory.GetDataAccess(DataAccessType.AdminEmail);
