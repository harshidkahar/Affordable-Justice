...
{
    public class AdminCommonDA :IDataAccess
    {
        public SqlConnection con = new SqlConnection();
        
        public DataSet GetAdminCommonFillData(int id, string searchtext, string opt)
        {
            DataSet ds = new DataSet();
            try
            {
                con = DataAccess.OpenConnection();
                SqlCommand cmd = new SqlCommand("[dbo].[Common_Fill_Admin]", con);
