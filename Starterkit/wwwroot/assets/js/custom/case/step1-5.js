...
const nextButton8 = document.querySelector('[data-kt-element="jurd-next"]');
nextButton8.addEventListener('click', function (e) {
    // Prevent default button action
    e.preventDefault();

    // Get the selected radio input value
    const selectedRadio6 = document.querySelector('input[name="jurdtype"]:checked');

    if (selectedRadio6) {
        jurdtype = selectedRadio6.value;
        console.log('Variable stored:', jurdtype);
...
const nextButton12 = document.querySelector('[data-kt-element="quote-next"]');
nextButton12.addEventListener('click', function (e) {
    // Prevent default button action
    e.preventDefault();

    // Get the selected radio input value
    const selectedRadio10 = document.querySelector('input[name="quote"]:checked');

    if (selectedRadio10) {
        quote = selectedRadio10.value;
        console.log('Variable stored:', quote);
